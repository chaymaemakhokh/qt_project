...
bool ContrainteCompatibilite::isCompatible() const { return m_compatible; }
...
void ReglesCompatibilite::definirCompatibilite(TypeProduit a, TypeProduit b, bool ok)
{
    ajouterContrainte(ContrainteCompatibilite(a, b, ok));
}
